...
pub enum SocketMessage {
    ...
    ToggleMonocle,
    SetMonocleWidth(f32),
    AdjustMonocleWidth(Sizing),
    SetMonocleHeight(f32),
    AdjustMonocleHeight(Sizing),
    ToggleMaximize,
    ...
    StackbarFocusedBackgroundColour(u32, u32, u32),
    StackbarUnfocusedBackgroundColour(u32, u32, u32),
    StackbarHeight(i32),
