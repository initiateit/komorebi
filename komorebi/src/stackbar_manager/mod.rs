...
pub static STACKBAR_TAB_FOCUSED_BACKGROUND_COLOUR: AtomicU32 = AtomicU32::new(3355443); // gray
pub static STACKBAR_TAB_UNFOCUSED_BACKGROUND_COLOUR: AtomicU32 = AtomicU32::new(3355443); // gray
